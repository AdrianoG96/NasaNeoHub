  ...
  return (
    <>
      ...
      <div className="border-t border-white/5 bg-white/[0.02] py-3">
        <p className="text-center text-[10px] tracking-wider text-white/25 font-mono">
          🚀 Developed By Adriano Gangemi — 🤖 Ai Driven Development — ⚡ Cline feat DeepSeek V4 Flash
        </p>
      </div>
    </>
  )
